                  ...
                  <span class="app-brand-logo demo">
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="username" name="name" placeholder="Enter your username" autofocus/>
                            @error('name')
...
<div class="buy-now">
    <a
        href="{{route('front.index')}}" target="_blank" class="btn btn-danger btn-buy-now">Go To Website</a>
</div>
